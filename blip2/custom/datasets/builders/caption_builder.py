...
from blip2.custom.datasets.datasets.coco_caption_datasets import (
    COCOCapDataset,
...
from blip2.custom.datasets.datasets.textcaps_datasets import TextCapsCapDataset, TextCapsCapInstructDataset, TextCapsCapEvalDataset
