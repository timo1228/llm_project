...
from custom.common.dist_utils import get_rank, get_world_size, is_main_process
from custom.common.registry import registry
from custom.common.vqa_tools.vqa_eval import VQAEval as VQATool
from custom.tasks.vqa import VQATask
